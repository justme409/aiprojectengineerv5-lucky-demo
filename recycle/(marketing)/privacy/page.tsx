    ...
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg prose-slate dark:prose-invert mx-auto">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">How We Use Information</h2>
            <ul className="text-slate-600 dark:text-slate-300 list-disc pl-6 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Sharing</h2>
            <p className="text-slate-600 dark:text-slate-300 mb-4">
              We don&apos;t sell personal data. We may share limited information with service providers strictly to operate the product (e.g., authentication, storage, payments) and when required by law.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Retention</h2>
            <p className="text-slate-600 dark:text-slate-300 mb-4">
              We retain information for as long as needed to provide the service and to meet legal obligations. You may request deletion of your account data at any time.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Your Choices</h2>
            <ul className="text-slate-600 dark:text-slate-300 list-disc pl-6 space-y-2">
