...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center space-y-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
              Complete Project
              <span className="text-emerald-600 dark:text-emerald-400"> Quality Assurance</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/about">
                <Button variant="outline" size="lg" className="px-8 border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                  Learn More
                </Button>
              </Link>
            </div>
