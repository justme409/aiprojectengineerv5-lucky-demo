			...
			<div className="bg-card rounded-lg border shadow-sm p-6">
				<div className="flex justify-between items-start">
					<div className="flex-1">
						<h1 className="text-3xl font-bold text-card-foreground">{project.projectName || project.name || 'Project'}</h1>
						<p className="text-muted-foreground mt-2">{project.projectDescription || project.description || project.scopeSummary}</p>
					</div>
