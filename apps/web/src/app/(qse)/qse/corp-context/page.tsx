          ...
          <div className="bg-white border border-slate-300">
            ...
            <div className="p-8 prose prose-slate max-w-none">
              <div className="grid grid-cols-3 gap-4 mb-8 text-sm">
                ...
                <div className="border p-3"><span className="font-semibold">Revision:</span> —</div>
                <div className="border p-3"><span className="font-semibold">Effective Date:</span> —</div>
              </div>
              <QseDocEditor docId="QSE-4.1-PROC-01" />
          ...
          <div className="bg-white border border-slate-300">
            ...
            <div className="p-8 prose prose-slate max-w-none">
              <div className="grid grid-cols-3 gap-4 mb-8 text-sm">
                ...
                <div className="border p-3"><span className="font-semibold">Revision:</span> —</div>
                <div className="border p-3"><span className="font-semibold">Last Updated:</span> —</div>
              </div>
              <QseDocEditor docId="QSE-4.1-REG-01" />
        ...
        <section id="stakeholders-register" className="scroll-mt-8">
          <div className="bg-white border border-slate-300">
            ...
            <div className="p-8 prose prose-slate max-w-none">
              ...
              <QseDocEditor docId="QSE-4.2-REG-01" />
