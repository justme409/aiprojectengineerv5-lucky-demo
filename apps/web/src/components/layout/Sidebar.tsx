  ...
  const getSectionsForProject = (projectId: string, jurisdiction?: string): Section[] => {
    ...
    const sections: Section[] = [
      ...
      },
      {
        ...
        links: [
          { label: 'Schedule Items', href: `/projects/${projectId}/progress/schedule-items`, icon: FileText },
          { label: 'Progress Claims', href: `/projects/${projectId}/progress/claims`, icon: FileText },
          { label: 'Variations', href: `/projects/${projectId}/progress/variations`, icon: FileText },
        ],
      },
      {
        id: 'documents',
